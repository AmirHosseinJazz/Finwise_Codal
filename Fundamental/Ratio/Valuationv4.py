...
async def SortOneOut(ID,session):
    ...
    try:
        ...
        if (G1>0.6):
            G1=0.6
        PeterLynch=(Quarterly[Quarterly['translatedName']=='EarningWithouNRI'].iloc[0].TTM*100*G1*1000000*PEGWholeMarket)/float(LastShareCount)   

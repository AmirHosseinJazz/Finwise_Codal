        ...
        for UniqueToDate in Quarterly.toDate.unique().tolist():
            try:
                ...
                try:
                    ...
                    Mcap=HistoricMarketCap.iloc[0].MarketCap
                try:
                    DPSTemp=DPSALL[DPSALL['year']==year].iloc[0].Value
                except:
                    DPSTemp=0
...
if __name__=="__main__":
    ...
    # asyncio.get_event_loop().run_until_complete(download_All(pd.DataFrame([{'ID':'4443'}])))            

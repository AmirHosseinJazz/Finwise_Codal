...
IC_license=['lblNinethPlaning','lblNinethTransparenciesObserveInstructions','lblNinethTransparenciesImpotant']

false_Labels=['lblNinethPlaning','lblNinethTransparenciesObserveInstructions','lblNinethTransparenciesImpotant']
...
def log_it(text):
    try:
        ...
        record_to_insert = (str(datetime.datetime.now()),text,'S5')

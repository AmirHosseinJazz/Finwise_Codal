...
IC_license=['lblFourteenthPlaning','lblFourteenthTransparenciesImpotant','lblFourteenthToDate','lblFourteenthFromDate']

false_Labels=['lblFourteenthPlaning','lblFourteenthTransparenciesImpotant','lblFourteenthToDate','lblFourteenthFromDate']
...
def log_it(text):
    try:
        ...
        record_to_insert = (str(datetime.datetime.now()),text,'S8')
...
def get_unconverted():
    try:
        ...
        select * FROM codalraw."allrawReports" where "LetterCode"='س-۸' and "HtmlUrl"!='' and "Available"=True and "TracingNo" not in (select "report_ID" from codalraw."orgClarificationConverted")
            ...
            $$
                BEGIN
                    IF NOT EXISTS (select from  codalreports."OrgClarification_Article19" where "report_id"=%(report_id)s) THEN
                        ...
                        %(lblFourteenthTransparenciesImpotant)s,%(lblFourteenthToDate)s
                        );
                    END IF;
                END
            $$ 

...
IC_license=['lblEleventhTransparenciesImpotant',
            'lblEleventhPlaning','lblEleventhLetterNo','lblEleventhLetterDate']

false_Labels=['lblEleventhTransparenciesImpotant',
            'lblEleventhPlaning','lblEleventhLetterNo','lblEleventhLetterDate']
...
def log_it(text):
    try:
        ...
        record_to_insert = (str(datetime.datetime.now()),text,'FB7')

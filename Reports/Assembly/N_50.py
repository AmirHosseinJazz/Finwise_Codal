...
def get_unconverted():
    try:
        ...
        select * FROM codalraw."allrawReports" where 
        ("LetterCode"='ن-۵۰' or "LetterCode"='ن-۵۶' or "LetterCode"='ن-۵۴') 
         and "HtmlUrl"!='' and "Available"=True and "TracingNo" not in (select "report_ID" from codalraw."AssemblyConverted")
